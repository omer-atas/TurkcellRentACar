...
public class CarsController {
	...
	@GetMapping("/carCanBeRent/{carId}")
	public DataResult<CarGetDto> carCanBeRent(@RequestParam("carId") int carId) throws BusinessException{
		return this.carService.carCanBeRent(carId);
	}
